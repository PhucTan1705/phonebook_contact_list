...
import 'package:rx_dart_phonebook/blocs/auth_bloc/auth_bloc.dart';
import 'package:rx_dart_phonebook/blocs/auth_bloc/auth_error.dart';
import 'package:rx_dart_phonebook/blocs/contact_bloc.dart';
import 'package:rx_dart_phonebook/blocs/views_bloc/current_view.dart';
import 'package:rx_dart_phonebook/blocs/views_bloc/views_bloc.dart';
...
class AppBloc {
  ...
  factory AppBloc() {
    ...
    //chuyen userid tu auth bloc sang contacts bloc
    ...
    final Stream<CurrentView> currentViewBasedOnAuthStatus =
        authBloc.authStatus.map<CurrentView>(
      (authStatus) {
